...
dat <- readRDS("R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/offset_DO_dat/light/24_GBU_DO_flag_sat_light.rds") %>%
  filter(maintenance_flag<1 & maintenance_flag<1 & datetime > as.POSIXct("2021-04-01 00:00:00") & datetime < as.POSIXct("2024-08-01 00:00:00")& 
           do.obs>3.85) # & fouling_flag<1 &  datetime > as.POSIXct("2021-04-29 11:15:39"))
summary(dat)
...
dat$solar.time <- calc_solar_time(dat$rounded_datetime, -119.9399057)
...
Summer_test <- subset(dat, solar.time > "2021-08-05 00:00:00" & solar.time < "2021-08-07 00:00:00")
...
# bayes_specs_new$K600_lnQ_nodes_meanlog <- c(rep(-3.79, 6))
...
# # Adjust priors for K600
 bayes_specs_new$K600_lnQ_nodes_centers <- seq(logQ_range[1]+1.75, logQ_range[2], length.out = 6)
 bayes_specs_new$K600_lnQ_nodes_meanlog <- c(4.35, # measured
                                             4.22, # median
                                             3.65, # measured
                                             3.08, # measured
                                             3.00, # measured
...
DOplot
# 
ggsave(plot = DOplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/DO_preds_GBU_bayesmodel_mK600_filter_hr_250106.png",sep=""),width=10,height=4,dpi=300)

metabplot<- plot_metab_preds(predict_metab(dat_metab_GBU))
# 
ggsave(plot = metabplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/metabplot_GBU_bayesmodel_mK600_filter_hr_250106.png",sep=""),width=10,height=4,dpi=300)
...
ggsave(plot = binplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/binplot_GBU_bayesmodel_mK600_filter_hr_250106.png",sep=""),width=5,height=4,dpi=300)
...
# saveRDS(dat_metab_GBU, file = "R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/GBU_Summer_K600_measured_prior_noGPPprior_241225.rds")
...
GBU <- read.csv("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/GBU_K600_measured_hr_filter_NLDAS_daily250102.csv")
...
#
ggsave(plot = k_grid, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/ER_K600plot_GBU_K600_measure_prior_filter_hr_NLDAS_daily250102.png",sep=""),width=6,height=3,dpi=300)
...
ggsave(plot = k_e_grid, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/GBU_K600_conditions_prior_filter_NLDAS_measure_hr_daily250102.png",sep=""),width=4,height=12,dpi=300)
