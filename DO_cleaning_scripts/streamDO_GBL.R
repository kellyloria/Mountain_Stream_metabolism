...
# "R:\Users\kloria\Documents\Stream_Metab_24\Core_sites\GBL_DO\RawDO_GBL"
data_dir <- "R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/GBL_DO/RawDO_GBL/"
...
do.ts1 <- subset(do.ts, 
                   datetime < "2024-10-08 00:00:00 PDT")
# write.csv(x = do.ts1, file = "R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/raw_merged_dat/25_GBL_rawDO_record.csv", row.names = TRUE)
# saveRDS(do.ts, file = "R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/raw_merged_dat/25_GBL_rawDO_record.rds")


tempcheck <- subset(do.ts1, 
