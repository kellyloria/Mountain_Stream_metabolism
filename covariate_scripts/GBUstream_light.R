...
## ===============================
### Read in DO data
dat <- readRDS("R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/offset_DO_dat/saturation/25_GBU_DO_flag_sat.rds")

names(dat)
#39.088169, -119.937005
...
GBU_dat2 <- GBU_dat %>%
  mutate(solar.time = calc_solar_time(rounded_datetime_15min, -119.937005),
         calclight = calc_light(solar.time, 39.088169, -119.937005),
...
# saveRDS(GBU_dat2, "R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/offset_DO_dat/light/25_GBU_DO_flag_sat_light.rds")
