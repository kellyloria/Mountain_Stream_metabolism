...
site <- "BWL"
dat <- readRDS("R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/offset_DO_dat/light/25_BWL_DO_flag_sat_light.rds")
...
bayes_specs_new$K600_lnQ_nodes_centers <- seq(c(logQ_range[1]+0.25), c(logQ_range[2]-0.25), length.out = 6)
...
output_path <- "R:/Users/kloria/Documents/Stream_Metab_24/model_output/BWL"
