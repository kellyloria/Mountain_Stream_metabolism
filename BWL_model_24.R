...
dat <- readRDS("R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/offset_DO_dat/light/24_BWL_DO_flag_sat_light.rds") %>%
  filter(datetime > as.POSIXct("2021-04-29 11:15:39")) #maintenance_flag<1 & fouling_flag<1 &  
summary(dat)

dat <- dat %>%
  filter(maintenance_flag<1 & fouling_flag<1 &  datetime < as.POSIXct("2024-08-12 00:00:00"))
summary(dat)
...
Summer_test <- subset(dat, solar.time > "2021-06-05 00:00:00" & solar.time < "2021-10-05 20:00:00")


# Check timestamp format with light or temp
qplot(solar.time,  temp.water, data = Summer_test, geom="point") +
  theme(axis.text.x = element_text(angle = 25, vjust = 1.0, hjust = 1.0))+
  scale_x_datetime(labels = date_format("%m/%d %H:%M"),
                   breaks = date_breaks("120 hours"))
...
## Visualize
DOplot <-plot_DO_preds((dat_metab_BW))


# 
ggsave(plot = DOplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/DO_preds_BWL_bayesmodel_measuredK600_no_filter.png",sep=""),width=10,height=4,dpi=300)

metabplot<- plot_metab_preds(predict_metab(dat_metab_BW))
# 
ggsave(plot = metabplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/metabplot_BWL_bayesmodel_measuredK600_no_filter.png",sep=""),width=10,height=4,dpi=300)
...
ggsave(plot = binplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/binplot_BWL_bayesmodel_measuredK600_no_filter.png",sep=""),width=5,height=4,dpi=300)
...
# saveRDS(dat_metab_BW, file = "R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/BWL_Summer_K600_measured_prior_241208.rds")
...
BWL <- read.csv("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/BWL_K600_measured_prior_noGPP_prior_no_filter_NLDAS_daily241213.csv")
...
#
ggsave(plot = k_grid, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/ER_K600plot_BWL_K600_measured_prior_no_filter_daily241213.png",sep=""),width=6,height=3,dpi=300)
...
ggsave(plot = k_e_grid, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/BWL_K600_conditions_plot_measured_noGPP_prior_no_filter_241213.png",sep=""),width=4,height=12,dpi=300)
