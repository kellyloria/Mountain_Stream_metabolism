...
dat <- readRDS("R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/offset_DO_dat/light/24_GBL_DO_flag_sat_light.rds") %>%
  filter(maintenance_flag<1 & maintenance_flag<1 & datetime > as.POSIXct("2021-06-30 00:00:00") & datetime < as.POSIXct("2024-10-15 00:00:00")) # & fouling_flag<1 &  datetime > as.POSIXct("2021-04-29 11:15:39"))
summary(dat)
...
DOplot
# 
ggsave(plot = DOplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/DO_preds_GBL_bayesmodel_estK600_filter_250102.png",sep=""),width=10,height=4,dpi=300)

metabplot<- plot_metab_preds(predict_metab(dat_metab_GBL))
# 
ggsave(plot = metabplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/metabplot_GBL_bayesmodel_estK600_filter_250102.png",sep=""),width=10,height=4,dpi=300)
...
ggsave(plot = binplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/binplot_GBL_bayesmodel_estK600_filter_250102.png",sep=""),width=5,height=4,dpi=300)
...
runmeta_k600 <- "K600_est_prior_filter"
runmeta_light <- "NLDAS"
