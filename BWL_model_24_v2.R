...
site <- "BWL"
dat <- readRDS("R:/Users/kloria/Documents/Stream_Metab_24/Core_sites/offset_DO_dat/light/24_BWL_DO_flag_sat_light.rds") %>%
  filter(maintenance_flag<1 & maintenance_flag<1 & datetime > as.POSIXct("2021-04-21 00:00:00") & datetime < as.POSIXct("2024-08-01 00:00:00") &  do.obs>3.85) # & fouling_flag<1 &  datetime > as.POSIXct("2021-04-29 11:15:39"))
summary(dat)
...
# Run the model
##==============
dat_metab_BWL <- metab(bayes_specs_new, data = dat3)

# extract fit:
dat_fit_BWL <- get_fit(dat_metab_BWL)

## Visualize
DOplot <-plot_DO_preds((dat_metab_BWL))
DOplot
# 
ggsave(plot = DOplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/DO_preds_BWL_bayesmodel_mK600_filter_250107.png",sep=""),width=10,height=4,dpi=300)

metabplot<- plot_metab_preds(predict_metab(dat_metab_BWL))
# 
ggsave(plot = metabplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/metabplot_BWL_bayesmodel_mK600_filter_250107.png",sep=""),width=10,height=4,dpi=300)
...
binplot<- Binning(dat_fit_BWL, dat_metab_BWL)

ggsave(plot = binplot, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_figure/binplot_BWL_bayesmodel_mK600_filter_250107.png",sep=""),width=5,height=4,dpi=300)

# ggsave(plot = binplot, filename = paste("R:/Users/kloria/Documents/2023_StreamMetab/figures/binplot_BWL_K600_measured_prior_filter_241225.png",sep=""),width=5,height=4,dpi=300)


get_fit(dat_metab_BWL)$overall %>%
...
writefiles(dat_fit_BWL, dat_metab_BWL)


getwd()


# saveRDS(dat_metab_BWL, file = "R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/BWL_Summer_K600_measured_prior_noGPPprior_241225.rds")
...
BWL <- read.csv("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/BWL_K600_est_prior_filter_NLDAS_daily250102.csv")
...
#
ggsave(plot = k_grid, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/ER_K600plot_BWL_K600_est_prior_filter_NLDAS_daily250102.png",sep=""),width=6,height=3,dpi=300)
...
ggsave(plot = k_e_grid, filename = paste("R:/Users/kloria/Documents/Stream_Metab_24/24_metabolism_output/Full_out/BWL_K600_conditions_prior_filter_NLDAS_daily250102.png",sep=""),width=4,height=12,dpi=300)
